...
- **Software Engineer @ Athena Systems**  
  Built Python, SQL, and Flask tools for financial data operations, reducing support ticket resolution time by 30%.

- **Full Stack Developer @ Inprosa**  
  Developed tournament management systems and business workflows with Laravel, Livewire, PHP, MySQL, and Tailwind CSS.
...
![Django REST](https://img.shields.io/badge/Django_REST-092e20?style=flat-square)
...
- Clean, maintainable systems with a clear source of truth
- Production reliability, observability, and simple operations
- AI tools that solve real workflow problems instead of adding noise
- Fast iteration without hiding errors or complexity
- Products that feel useful, polished, and grounded in user needs
